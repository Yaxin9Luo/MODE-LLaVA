...
class MGMMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        # print(f"Image features shape: {image_features.shape}")  # New print statement
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # print(f"Batch {batch_idx}: Number of image tokens: {num_images}")  # New print statement
            if num_images == 0:
            ...
            # print(f"Batch {batch_idx}: Image token indices: {image_token_indices}")  # New print statement
            cur_input_ids_noim = []
            ...
            for i in range(num_images + 1):
                ...
                if i < num_images:
                    cur_image_features = image_features[cur_image_idx]
                    # print(f"Batch {batch_idx}, Image {i}: Image feature shape: {cur_image_features.shape}")  # New print statement
                    cur_image_idx += 1
            ...
            # print(f"Batch {batch_idx}: Final input embeds shape: {cur_new_input_embeds.shape}")  # New print statement
            # print(f"Batch {batch_idx}: Final labels shape: {cur_new_labels.shape}")  # New print statement
