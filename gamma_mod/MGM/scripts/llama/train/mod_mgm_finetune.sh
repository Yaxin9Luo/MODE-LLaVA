...
FINETUNE_NAME=mod-MGM-7B-HD-route_0.5
AUX_SIZE=768
...
deepspeed mgm/train/train_mem.py \
    ...
    --version v1 \
    --data_path /data/luogen_code/MGM/playground/data/modified_mgm_instruction.json \
    --image_folder /data/luogen_code/MGM/playground/data \
    ...
    --pretrain_mm_mlp_adapter /data/luogen_code/MGM/work_dirs/MGM-Pretrain/MGM-7B/mm_projector.bin \
