...
# import sys
# sys.path.append('../')
from gamma_mod.eval.utilities import *

# OpenAI
import openai
openai.api_key = os.getenv("OPENAI_API_KEY")
# print(openai.api_key)
openai.api_key='sk-IWnsb9byXwHao0kdD13fBf800994402bBc5cFb18EbEe229f'
openai.api_base = "https://api3.apifans.com/v1"
# load demo prompt
from gamma_mod.eval.prompts.ext_ans import demo_prompt
...
if __name__ == '__main__':
    ...
    # input
    parser.add_argument('--output_dir', type=str, default='./playground/data/eval/mathvista/results')
